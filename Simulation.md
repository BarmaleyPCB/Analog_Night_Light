...
Логический уровень АМ312 находится в диапазоне 3.3V И его эквивалент в Multisim я сделал... Из обычного тумблера и питания. В реальности благодаря [пироэлектрического эффекта](https://ru.wikipedia.org/wiki/Пироэлектрики) о н поднимается моментально в ≈ 3.3V и держится в этом диапазоне где несколько секунд.
